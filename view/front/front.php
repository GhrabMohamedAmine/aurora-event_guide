...
echo '<div style="position: fixed; top: 20px; left: 20px; z-index: 1000;">
        <a href="../back/offre.php" class="nav-button" id="offre-nav-btn" style="display: flex; align-items: center; gap: 8px; 
           background: linear-gradient(135deg, #301934 0%, #4b0082 100%); color: white; 
      ...
      <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            navBtn.addEventListener("mouseover", function() {
                ...
                this.style.boxShadow = "0 6px 15px rgba(48, 25, 52, 0.4)";
            });
...
<head>
    ...
    <script>
        // Function to show and hide tabs - defined early to be available for onclick events
    ...
    <style>
        :root {
            --primary-color: #301934; /* Updated purple color */
        ...
        .btn-purple:hover {
            ...
            box-shadow: 0 6px 15px rgba(48, 25, 52, 0.3);
        }
        ...
        .package-card {
            background: #602299; /* Updated background color */
            border-radius: 10px;
            overflow: hidden;
        ...
        .package-card:hover {
            ...
            box-shadow: 0 15px 30px rgba(48, 25, 52, 0.2);
        }
        ...
        .form-control:focus {
            ...
            outline: none;
            box-shadow: 0 0 0 2px rgba(48, 25, 52, 0.2);
        }
        ...
        .sponsorship-card {
            background: #602299; /* Updated background color */
            border-radius: 15px;
            box-shadow: 0 8px 20px rgba(48, 25, 52, 0.1);
            padding: 25px;
            transition: all 0.3s ease;
            border: 1px solid rgba(48, 25, 52, 0.05);
            position: relative;
            overflow: hidden;
        }
        ...
        .sponsorship-header {
            border-bottom: 2px solid rgba(48, 25, 52, 0.1);
            margin-bottom: 20px;
            padding-bottom: 15px;
            position: relative;
        }
        ...
        .sponsor-actions {
            ...
            margin-top: 20px;
            border-top: 1px solid rgba(48, 25, 52, 0.1);
            padding-top: 15px;
        }
        ...
        .action-btn.edit:hover {
            background-color: rgba(48, 25, 52, 0.2);
        }
        ...
        .modal-content {
            background-color: #602299; /* Updated background color */
            border-radius: 15px;
            width: 90%;
            max-width: 450px;
...
<body>
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="card shadow-sm border-0">
                                <div class="card-header bg-gradient-primary text-white d-flex justify-content-between align-items-center py-3">
                                    ...
                                    <a href="/EVENMENT/view/front/messenger.php" class="btn btn-light btn-sm rounded-pill px-3 d-flex align-items-center">
                                ...
                                <div class="card-body p-0">
                                    <?php if (empty($conversations)): ?>
                                        <div class="text-center py-5">
                                            ...
                                            <a href="/EVENMENT/view/front/messenger.php" class="btn btn-primary px-4 rounded-pill">
                                    ...
                                    <?php else: ?>
                                        <div class="message-list">
                                            <?php foreach (array_slice($conversations, 0, 3) as $conversation): ?>
                                                <a href="/EVENMENT/view/front/messenger.php?sponsor=<?php echo $conversation['id_sponsor']; ?>" class="message-item p-3 d-flex align-items-center border-bottom transition">
                                        ...
                                        <?php if (count($conversations) > 3): ?>
                                            <div class="text-center py-3 border-top">
                                                <a href="/EVENMENT/view/front/messenger.php" class="text-primary font-weight-bold">
        ...
        <div class="request-section" id="request-form">
            ...
            <form method="POST" id="demandeForm">
                ...
                <div class="form-group">
                    <label>Sponsor</label>
                    <select name="id_sponsor" id="id_sponsor" class="form-control" required>
                        <option value="">Sélectionnez un sponsor</option>
                        <?php foreach ($sponsors as $sponsor): ?>
                            <option value="<?php echo htmlspecialchars($sponsor['id_sponsor']); ?>">
                                <?php echo htmlspecialchars($sponsor['entreprise'] . ' - ' . $sponsor['nom_sponsor']); ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="idevent" id="idevent" class="form-control" required>
                        ...
                        <?php foreach ($events as $event): ?>
                            <option value="<?php echo htmlspecialchars($event->getIdEvent()); ?>">
                                <?php echo htmlspecialchars($event->getTitre() . ' - ' . $event->getDate() . ' - ' . $event->getLieu()); ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
    ...
    <footer>
        <div class="container">
            <p>© <?php echo date('Y'); ?> Festival Sponsoring. Tous droits réservés.</p>
        </div>